...
const VERSION = 'weekend_shift_responsibility_2026_08_21_v3';
...
const TEMPLATES: Record<string, ResponsibilityTemplate> = {
  fri_opening: {
    key: 'fri_opening', labelZh: '周五早班', labelEn: 'Fri Opening', roleZh: '补料责任人', roleEn: 'Prep owner',
  ...
  fri_support: {
    key: 'fri_support', labelZh: '周五中班', labelEn: 'Fri Support', roleZh: '出杯支援 / 货架上架责任人', roleEn: 'Drink support / Shelf restock owner',
  ...
  fri_closing: {
    key: 'fri_closing', labelZh: '周五晚班', labelEn: 'Fri Closing', roleZh: '盘货责任人', roleEn: 'Inventory count owner',
  ...
  sat_opening: {
    key: 'sat_opening', labelZh: '周六早班', labelEn: 'Sat Opening', roleZh: '补料责任人', roleEn: 'Prep owner',
  ...
  sat_peak: {
    key: 'sat_peak', labelZh: '周六高峰班', labelEn: 'Sat Peak', roleZh: '出品责任人', roleEn: 'Drink production owner',
  ...
  sat_closing: {
    key: 'sat_closing', labelZh: '周六晚班', labelEn: 'Sat Closing', roleZh: '盘货责任人', roleEn: 'Inventory count owner',
  ...
  sun_opening: {
    key: 'sun_opening', labelZh: '周日早班', labelEn: 'Sun Opening', roleZh: '整理责任人', roleEn: 'FIFO organization owner',
  ...
  sun_closing: {
    key: 'sun_closing', labelZh: '周日晚班', labelEn: 'Sun Closing', roleZh: '盘货责任人', roleEn: 'Inventory count owner',
...
function getContext(schedule: any, currentUser: User | null | undefined, storeId: string, now: Date): ShiftContext | null {
  ...
  const candidates = today.shifts
    ...
    .map((shift: any) => {
      ...
      return { shift, template, start, end, priority: active ? 0 : pre ? 1 : 2, distance: Math.abs(start - nowMinutes) };
    })
    .filter(Boolean)
...
export function WeekendShiftResponsibilityGate({ currentUser, schedule, storeId, lang }: { currentUser: User | null | undefined; schedule: any; storeId: string; lang: Lang }) {
  ...
  return <>
    ...
    {open && <div className="fixed inset-0 z-[11800] flex items-center justify-center bg-black/90 p-3 backdrop-blur-md" role="alertdialog" aria-modal="true">
...
class WeekendResponsibilityBoundary extends React.Component<{ children: React.ReactNode }, { failed: boolean }> {
  state = { failed: false };
  static getDerivedStateFromError() { return { failed: true }; }
  componentDidCatch(error: unknown, info: React.ErrorInfo) { console.error('Weekend responsibility module crashed and was isolated', error, info); }
  render() { return this.state.failed ? null : this.props.children; }
}

export function SafeWeekendShiftResponsibilityGate(props: { currentUser: User | null | undefined; schedule: any; storeId: string; lang: Lang }) {
  return <WeekendResponsibilityBoundary><WeekendShiftResponsibilityGate {...props} /></WeekendResponsibilityBoundary>;
}
